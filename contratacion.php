        ...
        <div class = "section">
          ...
          <div class="row">
            <div class="input-field col l4 m4 s4 "> 
              <input id="Nombre" type="text" onchange="activarBoton()" name="Nombre">
              <label for="CURP">Nombre(S)</label>
            </div>
            
            <div class="input-field col l4 m4 s4 "> 
              <input id="ApPat" type="text" onchange="activarBoton()" name="ApPat">
              <label for="ApPat">Apellido Paterno></label>
            </div>
            
            <div class="input-field col l4 m4 s4 "> 
              <input id="ApMat" type="text" onchange="activarBoton()" name="ApMat">
          ...
          <div class="row">
              ...
              <div class="input-field col l4 m12 s12">
                ...
                <input id="email" name="email" type="email" class="validate" onchange="evalEmail()">
          ...
          <div class="row">
              <div class="col l6 m6 s12">
                    ...
                    <select class="icons" id="estados" onchange="delegacionVisual()" name="estados">
                      ...
                      <option value="Ciudad de México" data-icon='https://i.ibb.co/K9VyjB5/CDMX.png' class="left">Ciudad de México</option>
                      ...
                      <option value="Estado de México" data-icon='https://i.ibb.co/TLFgxBM/EDOMEX.png' class="left">Estado de México</option>
                      ...
                      <option value="Michoacán" data-icon='https://i.ibb.co/qrMt6PZ/Mich.jpg' class="left">Michoacán</option>
                      ...
                      <option value="Nuevo León" data-icon='https://i.ibb.co/P4ZxFJS/NL.png' class="left">Nuevo León</option>
                      ...
                      <option value="Querétaro" data-icon='https://i.ibb.co/MRjSJTZ/Queretaro.jpg' class="left">Querétaro</option>
                      <option value="Quintana Roo" data-icon='https://i.ibb.co/4mFnJBq/QRO.jpg' class="left">Quintana Roo</option>
                      <option value="San Luis Potosí" data-icon='https://i.ibb.co/XC5pt20/SLP.jpg' class="left">San Luis Potosí</option>
                      ...
                      <option value="Yucatán" data-icon='https://i.ibb.co/nf3XKGg/Yucatan.png' class="left">Yucatán</option>
            ...
            <div class="col l6 m6 s12" id="delegaciones" style="display:none">
                  <select class="icons" id="seleccionDelegacion" name="seleccionDelegacion" onchange="activarBoton()"> 
        ...
        <div class="section">
          <div class="row">
            <div class="input-field col l6 m6 s12">
              ...
              <select id="eventosTipo" name="eventosTipo" onchange="activarBoton()">
            ...
            <div class="input-field col l6 m6 s12" style="position:relative; bottom:21px">
              ...
              <p class="range-field">
                ...
                <input type="range" name="invitados" id="invitados" min="75" max="200" onchange="cambiaInvitados()"/>
              </p>
            </div>
          </div>
          <div class="row">
            ...
            <div class="input-field col l6 m6 s12">
              ...
              <input id="fechaEvento" name="fechaEvento" type="text" class="datepicker" placeholder="" onchange="fechaMueve()">
            ...
            <div class="input-field col l6 m6 s12" id="muestraHora" style="display:none">
              ...
              <select name="Hora" id="Hora" onchange="horaMueve()">
          ...
          <div class="row">
            ...
            <div class="input-field col l12 m12 s12" id="muestraDJ" style="display:none">
              ...
              <select class="icons" name="DJ" id="DJ" onchange="activarBoton()">
            ...
            <div class="input-field col l12 m12 s12" id="muestraLugar" style="display:none">
              <i class="material-icons prefix red-text">access_time</i>
              <select class="icons" name="Lugar" id="Lugar" onchange="activarBoton()">
      ...
      <div clas="container">
        <div class="row">
          <div class="input-field col l6 m6 s6 offset-l4">
            <input type="submit" class="btn" disabled="true" id="MandarForm">
